...
if(!empty($usern)){
    $action = $firstname . ' logged in';
    create_log($usern, $action); 
}
...
if(isset($_POST["name2check"]) && $_POST["name2check"] != ""){
    ...
    $sql_uname_check = mysql_query("SELECT UserName FROM admin WHERE UserName='$username' LIMIT 1"); 
...
if(isset($_POST["email2check"]) && $_POST["email2check"] != ""){
    ...
    $sql_uname_check = mysql_query("SELECT EmailAdd FROM admin WHERE EmailAdd='$email' LIMIT 1"); 
    $uname_check = mysql_num_rows($sql_uname_check);
...
<html lang="en">
  <head>
    ...
    <title>Kiffi Arts Print Shop Admin Template</title>
...
<body style="background-color: black">
    ...
    <header id="header">
      ...
      <div id="login-page" style="background-color: black">
        <div class="container">
         <?php 
                         if(isset($msg)){  
             ...
             ?>
              ...
              <form action="loginresults.php" method="post" class="form-login" name = "login"  method="POST">
                ...
                <h2 class="form-login-heading" style="background-color: red">ADMIN</h2>
                ...
                <div class="login-wrap">
                    ...
                    <br>
                    <br>
                    <button class="btn btn-theme btn-block" type="submit" style="background-color: red">
                                                             Sign in
                                                         </button>
