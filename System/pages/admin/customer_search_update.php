...
<html>
  ...
  <?php
   ...
   <body class="hold-transition skin-blue sidebar-mini">
                  ...
                  <div class="box border">
                     ...
                     <div class="form-top" style="padding-bottom:0px;">
                        <div class="form-top-left">
                           ...
                           <?php } ?>
                           <p>Contact Information <?php echo $num = $num;?></p>
                        </div>
                        ...
                        <div class="box-body">
                           ...
                           <?php
                              if(!empty($_GET['order'])){ //search information for temporary / confirmed reviewee
                                 ...
                                 $CP= $rowa['cake_price'];
                                 $FS= $rowa['figurine_other'];
                                 $BN= $rowa['branch_name'];
                                 $SD= $rowa['cake_duedate'];
                                 $DT= $rowa['dedicationT'];
                                 $CFC= $rowa['cake_coat_color'];
                                 $CF= $rowa['cake_frost'];
                                 $CS= $rowa['candle_selection'];
                              
                              
                                  $query3 = "SELECT fname, lname  FROM customer WHERE customer_ID='$value'";
                                  $r3 = @mysql_query($query3, $dbc); 
                                  $row3 = mysql_fetch_array($r3); 
                                   $query6 = "SELECT  lname  FROM customer WHERE customer_ID='$value'";
                                  $r6 = @mysql_query($query6, $dbc); 
                                  $row6 = mysql_fetch_array($r6); 
                              
                              
                              
                                  $row3['fname'] = ucwords($row3['fname']);
                                  $row6['lname'] = ucwords($row6['lname']);
                                  $usrcompletename3 = $row3['fname']." ".$row6['lname'];
                           ...
                           <div class="row">
                              <div class="container contactform center">
                                 <div class="sectionprof">
                                    <div class="col-sm-10">
                                       <h4><i class="fa  fa-file-text-o"></i> Cake Details </h4>
                                       <p> <label>Order ID</label> : <?php echo $rowa['cake_ID'];?> </p>
                                       <p> <label>Cake Theme</label> : <?php echo $rowa['cake_theme'];?> </p>
                                       ...
                                       <p> <label>Cake Frost Color</label> : <?php echo $rowa['cake_coat_color'];?> </p>
                                       ...
                                       <p> <label>Cake Quantity</label> : <?php echo $rowa['cake_quant'];?> </p>
                                       <p> <label>Other Concerns</label> : <?php echo $rowa['other_concerns'];?> </p>
                                       <p> <label>Cake Amount</label> : <?php echo $rowa['cake_price'];?> </p>
                                       <br>
                                 ...
                                 <div class="sectionact">
                                    <div class="col-md-12" >
                                       <center><label class="control-label"> DISPLAY THE IMAGE OF CAKE </label></center>
                                       <br>
                                       <?php echo "<img src='".$rowa['canvas']."' />"; ?> 
                                    </div>
                                 </div>
                              </div>
                              <form method=POST id="form4_<?php echo $i;?>" action="secretary-prescription.php">
                                 ...
                                 <a href="#" class="btndashboard edittreat" 
                                    data-am="<?php echo $CP; ?>" 
                                    data-one="<?php echo $FS; ?>"
                                    data-two="<?php echo $BN; ?>"
                                    data-three="<?php echo $SD; ?>"
                                    data-four="<?php echo $DT; ?>"
                                    data-five="<?php echo $CFC; ?>"
                                    data-six="<?php echo $CF; ?>"
                                    data-seven="<?php echo $CS; ?>"
                                    data-code="<?php echo $cake_ID; ?>"
                                    style="background: #d67c20;" data-toggle="modal" data-target=".edit-treat"> update order details</a></td>
                              </form>
      ...
      <input type="text" name="form-three" placeholder="Service Date" class="form-three1 form-control" id="form-three">
      </div>
      <div class="form-group">Dedication Text:
      <label class="sr-only" for="form-four">Wedding Price</label>
      <input type="text" name="form-four" placeholder="Dedication Text" class="form-four1 form-control" id="form-four">
      </div>
      <div class="form-group">Icing color:
      <label class="sr-only" for="form-five">Wedding Price</label>
      <input type="text" name="form-five" placeholder="Icing color" class="form-five1 form-control" id="form-five">
      </div>
      <div class="form-group">Frost Type:
      <label class="sr-only" for="form-six">Wedding Price</label>
      <input type="text" name="form-six" placeholder="Frost type" class="form-six1 form-control" id="form-six">
      </div>
      <div class="form-group">Candle
      <label class="sr-only" for="form-seven">Wedding Price</label>
      <input type="text" name="form-seven" placeholder="Candle Number" class="form-seven1 form-control" id="form-seven">
      </div>
      ...
      <input type="text" name="form-two" placeholder="Branch Name" class="form-two1 form-control" id="form-two">
      </div>
      <?php echo'<input type="hidden" name="url" value="36" >'; ?>
