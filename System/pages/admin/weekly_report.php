               ...
               <ul class="sidebar-menu">
                  ...
                  <li class=" treeview">
                     ...
                     <ul class="treeview-menu">
                        ...
                        <li ><a href="deliver-orders.php"><i class="fa fa-circle-o"></i> Confirmed Orders via phonecall</a></li>
...
?>"</h3>
      ...
      <div class="tab-content">
            ...
            <?php      $bi = mysql_query("SELECT Count(`order_catalog`) FROM `catalog_orderlist`");
             ...
             <td><a href="readynade_search.php?order_catalog=<?php echo $order_catalog;?>"  class="btndashboard" style="background: #227da0;">view</a></td>
