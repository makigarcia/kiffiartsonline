...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="treeview">
                     <a href="billing.php">
                     <i class="fa fa-usd"></i><span>Delivered Orders</span>
                     </a>  
                  </li>
                  <li class="treeview">
         ...
         <div class="content-wrapper">
            ...
            <section class="content">
                  ...
                  <div class="box border">
                     ...
                     <div class="form-top" style="padding-bottom:0px;">
                        <div class="form-top-left">
                           ...
                           <?php } ?>
                           <p>Contact Information: <?php echo $nums = $num;?>
                        </div>
                              ...
                              if(!empty($_GET['order_catalog'])){ //search information for temporary / confirmed reviewee
                                 ...
                                 //echo 'id is ---> ' . $value;
                                            ...
                                            $catalog_ID = $rowa['catalog_ID'];
                                             ...
                                             $row3['picture'] = ucwords($row3['picture']);
                        ...
                        <div class="row">
                           <div class="container contactform center">
                              ...
                              <div class="sectionact">
                                 <div class="col-md-12" >
                                  <center>  <label class="control-label">IMAGE SHIRT ORDER </label> </center>
                                    <br> <?php   echo ' <img src="uploads/'.$row3['picture'].' " style="width:400px; height:300px;"  > '; ?>
                                 </div>
                              </div>
                           </div>
               ...
               <?php }
                        ...
                        $value = ($_GET['r_order']);
                        //echo 'id is ---> ' . $value;
                        $search_reviewee = mysql_query("SELECT * from order_cake where order_ID = '$value'");
      ...
      <input type="text" name="form-am" placeholder="cake Price" class="form-am1 form-control" id="form-am">
      </div>
      <?php echo'<input type="hidden" name="url" value="38" >'; ?>
