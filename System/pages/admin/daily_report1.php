   ...
   <head>
     <meta charset="utf-8">
      ...
      <title>DAILY REPORT: <?php
                              ...
                              ?>                   
                         <?php echo "$num_rows";?> Unsucessful Delivery for <?php
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <ul class=" active treeview-menu">
                     ...
                     <li  class="active"><a href="daily_report1.php"><i class="fa fa-circle-o"></i> Daily Unsuccesful Report</a></li>
                  ...
                  <div class="box border">
                     ...
                     <div class="form-top" style="padding-bottom:0px;">
                        <div class="form-top-left">
                           <h3>Unsuccesful pick-up/delivery for <?php

echo "" . date("F j,Y") . "<br>";


?></h3>
                           <p>List of unsuccesful delivery orders of the customers.</p>
                        </div>
            ...
            <div class="form-bottom">
             <ul class="nav nav-tabs" id="myTab" style="margin-top:20px;">
                              ...
                              <li><a data-toggle="tab" href="#billing"><i class="fa fa-file-text"></i>&nbsp;Ready-Made Orders</a></li>
                           </ul>
      ...
      <div class="tab-content">
            ...
            <?php     
              $ai = mysql_query("SELECT Count(`cake_ID`) FROM `customized_cake` WHERE cake_duedate=CURDATE()");
               ...
               if($cnt!=0){
                     ...
                     for($i=0;$i<$cnt; $i++){
                       ...
                       if($reserve[$i][0]['order_pending']=="cancelled"){
