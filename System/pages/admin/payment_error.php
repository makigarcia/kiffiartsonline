                  ...
                  <div class="box border">
                     ...
                     <div class="form-bottom">
                       <ul class="nav nav-tabs" id="myTab" style="margin-top:20px;">
                           <li class="active"><a data-toggle="tab" href="#profile"><i class="fa fa-file-text"></i>&nbsp;Customized Cake Orders</a></li>
                           <!-- <li><a data-toggle="tab" href="#past"><i class="fa fa-file-text"></i>&nbsp;Past Orders</a></li> -->
                           <li><a data-toggle="tab" href="#billing"><i class="fa fa-file-text"></i>&nbsp;Cake Catalog Orders</a></li>
                        </ul>
                            ...
                            <div class="tab-content">
                              ...
                              <div class="table-responsive">
                                 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php      $ai = mysql_query("SELECT Count(`order_ID`) FROM `order_cake`");
                                             $a1 = mysql_fetch_array($ai);
                                             $cnt=$a1[0];
                                             
                                             if($cnt!=0){
                                             
                                                   $query1 = "SELECT * FROM order_cake";
                                                   $r1 = @mysql_query($query1, $dbc); 
                                                   ...
                                                   for($i=0;$i<$cnt; $i++){
                                                     $order=$reserve[$i][0]['order_ID'];
                                                     $id=$reserve[$i][0]['customer_ID'];
                                                     $PA=$reserve[$i][0]['payment_amount'];
                                               $PS=$reserve[$i][0]['payment_status'];
                                                      
                                                         $qtl = mysql_query("SELECT order_ID FROM  order_cake WHERE order_ID='$order'");
                                 ...
                                 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php      $ai = mysql_query("SELECT Count(`order_catalog`) FROM `catalog_orderlist`");
                                              ...
                                              while ($row1 = mysql_fetch_array($r1, MYSQL_ASSOC)) {
                                               ...
                                               for($c=0;$c<$cnt; $c++){
                                               $order1=$reserves[$c][0]['order_catalog'];
                                               $id1=$reserves[$c][0]['customer_ID'];
                                               $PAA=$reserves[$c][0]['payment_amount'];
                                               $PSS=$reserves[$c][0]['payment_status'];

                                                   $qtl = mysql_query("SELECT order_catalog FROM  catalog_orderlist WHERE order_catalog='$order1'");
                                               $t1 = mysql_fetch_array($qtl);
                                               $order_catalog=$t1[0];
               
               
                                               $query3= "SELECT fname, phone_num  FROM customer WHERE customer_ID='$id1'";
                                               $r3 = @mysql_query($query3, $dbc); 
                                               $row4 = mysql_fetch_array($r3); 
                                      
                                               $row4['fname'] = ucwords($row4['fname']);

                                               $row4['phone_num'] = ucwords($row4['phone_num']);
                                  ...
                                  <td><a href="catalog_search.php?order=<?php echo $order1;?>"  class="btndashboard" style="background: #227da0;">view</a></td>
                                    ...
                                    <form method=POST id="form2_<?php echo $c;?>" action="results.php">
                                       ...
                                       <?php echo'<input type="hidden" name="usern" value="' .$usern. '" >'; ?>
                                       <?php echo'<input type="hidden" name="url" value="32" >'; ?>
         ...
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  ...
                  <h4 class="modal-title" style="text-align:center;">Payment Customization Status</h4>
               </div>
