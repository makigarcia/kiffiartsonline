...
<html>
   <head>
     ...
     <title> REPORT MYRNA'S BAKEHOUSE : <?php
                              $link = mysql_connect("localhost", "root", "");
                              mysql_select_db("mrynas", $link);
                              
                              $result = mysql_query("SELECT * FROM customized_cake WHERE order_pending='delivered'", $link);
            ...
            <ul class="sidebar-menu">
               ...
               <li class="  active  treeview">
                  ...
                  <ul class=" active treeview-menu">
                     ...
                     <li class="active"><a href="monthly_report.php"><i class="fa fa-circle-o"></i> Monthly Succesful Report</a></li>
            ...
            <div class="box border">
               ...
               <div class="form-top" style="padding-bottom:0px;">
                  <div class="form-top-left">
                     <h3>Succesful Delivery Orders </h3>
                                    ...
                                    $ai = mysql_query("SELECT Count(`cake_ID`) FROM `customized_cake` ");
                                      ...
                                      if($cnt!=0){
                                            ...
                                            for($i=0;$i<$cnt; $i++){
                                              ...
                                              echo '          <tr>';
                                              echo '          <td>'.$dateee = $ddates.'</td>';
                                                 echo '          <td class="hidden">'. $ddateeeee = $reserve[$i][0]['cake_created'] - $reserve[$i][0]['cake_duedate'].' left</td>';
...
var countDownDate = new Date("cake_duedate").getTime();
...
var x = setInterval(function() {
    ...
    document.getElementById("P").innerHTML = days + "d " ;
    
    // If the count down is over, write some text 
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("P").innerHTML = "EXPIRED";
    }
}, 1000);
        }
             });
...
// Set the date we're counting down to
var countDownDate = new Date("Jan 5, 2018").getTime();
