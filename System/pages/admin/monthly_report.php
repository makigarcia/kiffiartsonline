...
<html>
   <head>
     ...
     <title> REPORT MYRNA'S BAKEHOUSE : <?php
                              ...
                              $result = mysql_query("SELECT * FROM order_list WHERE order_statusnew='delivered'", $link);
                                      ...
                                      if($cnt!=0){
                                            ...
                                            for($i=0;$i<$cnt; $i++){
                                              ...
                                              echo '          <td>'.$dateee = $ddates.'</td>';
                                                 echo '          <td class="hidden">'. $ddateeeee = $reserve[$i][0]['o_datenew'] - $reserve[$i][0]['d_datenew'].' left</td>';
...
var countDownDate = new Date("d_datenew").getTime();
