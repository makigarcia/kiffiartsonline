               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="pending-orders.php"><i class="fa fa-circle-o"></i> Approve Orders</a></li>
                        <li><a href="deliver-orders.php"><i class="fa fa-circle-o"></i> Pending Orders</a></li>
                        <li><a href="approved-orders.php"><i class="fa fa-circle-o"></i> Deliver Orders</a></li>
                     </ul>
                  </li>
                  <li class=" treeview">
