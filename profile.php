<?php
  ...
  $user_customer = $_SESSION ["cust_uname"];
  $read_cust = $_SESSION['customer_ID'];
?>
...
<link rel="stylesheet" href="assets/bootstrap/css/orangepace.css"> <!-- pace loading area -->
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="top-nav" style="background-color: black">
          <div class="container">
            <div class="navbar-header">
              <!-- Logo Starts --><a class="navbar-brand" href="home.php"> <img src="images/logoboth.jpg" alt="Smiley face" style="width: 50%"></a><!-- #Logo Ends -->
...
<div id="home">
  <div class="banner">
          <img src="images/img1.jpg" alt="banner" class="img-responsive">
          <div class="caption">
            <div class="caption-wrapper">
              <div class="caption-info"> 

          <?php  
          $disp_info = "SELECT * FROM customer WHERE customer_ID = '$read_cust'";
          $r = @mysql_query($disp_info, $link);
          $row = mysql_fetch_array($r);

              $username_customer = $row['cust_uname'];
              $user_fname = $row['fname'];
              $user_lname = $row['lname'];
              $user_add = $row['address'];
              $user_num = $row['phone_num'];
              $user_bday = $row['birthdate'];
          ?>
              <!-- <?php  echo "<h1 class='animated bounceInDown'>Hi, " . $username_customer . "!</h1>" ?> -->
              ...
              <!-- <p> <a class="btn btn-medium btn-orange" href="#portfolioModal_1" class="portfolio-link" data-toggle="modal">
              Start Designing</a> -->
              <!-- <a class="btn btn-medium btn-orange" href="#portfolioModal_2" class="portfolio-link" data-toggle="modal">
              Modify Cake</a> </p> -->

              <a href="#menu" class="explore animated bounceInDown"></a>
              </div>
            </div>
          </div>
  </div>
...
<!-- ********* PROFILE scroll part ********* -->
<div id="profile"  class="container spacer about">
        ...
        <div class="container contactform center">
                    <div class="sectionprof">
                      <div class="col-sm-10"> 
                          ...
                          <p> <label>First Name</label> : <?php echo "" . $user_fname . "" ?> </p>
                          <p> <label>Last Name</label> : <?php echo "" . $user_lname . "" ?> </p>
                          <p> <label>Delivery Address</label> : <?php echo "" . $user_add . "" ?> </p>
                          <p> <label>Phone Number</label> : <?php echo "" . $user_num . "" ?> </p>


                          <button class="btn btn-primary" href="#updateprofile" class="portfolio-link" data-toggle="modal"><i class="fa fa-pencil-square-o"></i>    EDIT  </button>
                          <button class="btn btn-primary" href="#portfolioModal_1" class="portfolio-link" data-toggle="modal"> Start Designing</button>
                      </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                      ...
                      <!-- **********  End  ORDER DISPLAY ************** TABLE  -->

                      <!-- *********** ORDER LIST STARTING*************-->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b> READY-MADE DESIGN ORDER LIST </b>
                        </div>
...
<!--  ********* P  O  P       O U T S !!!  ********* -->
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal_1" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="portfolio-modal modal fade" id="updateprofile" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                          ...
                          <p> <label>First Name</label>:<input type="text" size="30" name="newfirstname" placeholder="<?php echo "". $user_fname ."" ?>" id="newfirstname"> </p>
                          <p> <label>Last Name</label>:<input type="text" size="30"  name="newlastname" placeholder="<?php echo "". $user_lname ."" ?>" id="newlastname"> </p>
                          <p> <label>Delivery Address</label>:<input type="text" size="50" name="newaddress" placeholder="<?php echo "". $user_add ."" ?>" id="newaddress"> </p>
                          <p> <label>Phone Number</label>:<input type="text" size="30" name="newcontactnumber" placeholder="<?php echo "" . $user_num ."" ?>" id="newnewcontactnumber"> </p>

                      </div>
                      <div class="button-form">
                      <input type="submit" class="btn btn-primary btn-large btn-block" Style="width:80%;" value="Save" onclick="return confirm('Are you sure you want to change your information?')">
...
<!-- MODIFY CAKE CATALOG BUTTON APPEARS-->
      <div class="portfolio-modal modal fade" id="portfolioModal_2" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-content">
...
<script src="assets/googlemap.js"></script> 
  ...
  <script type="text/javascript" src="js/UpdateData.js"></script> <!-- update profile, not connected to db yet -->
